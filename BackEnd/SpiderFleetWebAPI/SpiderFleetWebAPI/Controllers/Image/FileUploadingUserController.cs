...
{
    public class FileUploadingUserController : ApiController
    {
        private const string Tag = "Mantenimiento de Imagen Usuario";
        private const string BasicRoute = "api/";
        private const string ResourceName = "administration/image/users";
        ...
        public async Task<ImageResponse> CreateUploadFileCompany()//[FromUri(Name = "user")] string user)
        {
            ...
            try
            {
                ...
                imagen.IdCompany = hierarchy;// user;
                imagen.Images = baseImage;

                try
                {
                    response= (new ImageDao()).CreateUser(imagen);
                }
                catch (Exception ex)
                {
                    response.success = false;
