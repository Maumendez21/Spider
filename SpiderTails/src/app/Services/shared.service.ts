...
export class SharedService {
  ...
  public rightMenu: BehaviorSubject<any> = new BehaviorSubject({
    title: "",
    tipe: true
  });
  ...
  public mapaDinamico: BehaviorSubject<boolean> = new BehaviorSubject(true);
  ...
  public broadcastRightMenuStream(type: any) {
    this.rightMenu.next(type);
  }
