...
@Component({
  selector: 'app-analisis-punto-interes',
  templateUrl: './analisis-punto-interes.component.html',
  styleUrls: ['./analisis-punto-interes.component.css']
})
export class AnalisisPuntoInteresComponent implements OnInit {
